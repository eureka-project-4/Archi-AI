...
class PersonalizedPricingAgent:
    ...
    def generate_recommendation_report(self) -> str:
        ...
        report = []
        report.append("=" * 50)
        report.append("🎯 개인 맞춤형 요금제 추천 보고서")
        report.append("=" * 50)
...
def main():
    ...
    print("  - 'recommend': 맞춤 요금제 추천")
    print("  - 'report': 상세 추천 보고서")
        ...
        try:
            ...
            if user_input.lower() == 'users':
                ...
                if not agent.current_user:
                    ...
                    print("🤖 개인 맞춤 요금제를 분석 중입니다...")
                    recommendation = agent.get_personalized_recommendation()
